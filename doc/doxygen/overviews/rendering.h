...
@page overview_rendering Rendering Overview

@tableofcontents

This is a general overview of rendering. This is necessarily a
tenative sketch of the process, both because it's incompletely
understood by the author and because many aspects of it are not
working correctly, i.e. many bugs have crept in.

To understand rendering in Xoanon Graphics, you first need an
understanding of the overall application framework.
