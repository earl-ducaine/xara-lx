...
class CCamFrame : public wxDocMDIParentFrame
{
 public:
 ...
 private:
  ...
  // Used to remember the unmin/maximised position
  wxRect m_WndRect;
 public:
  CCamFrame(wxDocManager *manager,
	    wxFrame *frame,
  ...
  ~CCamFrame();
  static CCamFrame * GetMainFrame() {
    return m_pMainFrame;
  }
  static wxAuiManager* GetFrameManager() {
    return m_pMainFrame ? m_pMainFrame->m_pFrameManager : NULL;
  }
  ...
  bool Create( wxWindow* parent,
	       wxWindowID id = -1,
	       const wxString &caption = wxT("wxTemplate"), 
	       const wxPoint &pos = wxDefaultPosition,
	       const wxSize &size = wxDefaultSize, 
	       long style = wxDEFAULT_FRAME_STYLE | wxVSCROLL | wxHSCROLL );
  bool IsChangingViewMode()				{ return m_ChangingViewMode;};
  void SetChangingMode(bool fSetOrClear)	{
    m_ChangingViewMode = fSetOrClear;
  };
