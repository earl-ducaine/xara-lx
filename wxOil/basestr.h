...
// $Id: basestr.h 1283 2006-06-09 10:45:34Z alex $
...
public:
    ...
    const StringBase& Left(StringBase* out, size_t count) const;
    const StringBase& Mid(StringBase* out, size_t first, size_t count) const;
    const StringBase& Right(StringBase* out, size_t count) const;
