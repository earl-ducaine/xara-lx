...
// $Id: basestr.cpp 1282 2006-06-09 09:46:49Z alex $
...
>   const StringBase& StringBase::Left(StringBase* out, INT32 count) const
    ...
    Purpose:    Similar to the BASIC Left$() string function: given a StringBase out, return
                a string count characters, also setting the current string, if any, to
    ...
    SeeAlso:    StringBase::Right
                StringBase::Mid
***************************************************************************************/
const StringBase& StringBase::Left(StringBase* out, size_t count) const
{
    ...
    {
        size_t text_string_length = std::min(camStrlen(text), count);
        if (count == 0)
        {
            *(out->text) = 0;
        }
...
>   const StringBase& StringBase::Mid(StringBase* out, INT32 first, INT32 count) const
    ...
    SeeAlso:    StringBase::Left
                StringBase::Right
***************************************************************************************/
const StringBase& StringBase::Mid(StringBase* out, size_t first, size_t count) const
{
...
>   const StringBase& StringBase::Right(StringBase* out, INT32 count) const
    ...
    SeeAlso:    StringBase::Left
                StringBase::Mid
***************************************************************************************/
const StringBase& StringBase::Right(StringBase* out, size_t count) const
{
