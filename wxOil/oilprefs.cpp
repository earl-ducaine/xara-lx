...
OILPreferences* OILPreferences::Init()
{
    ...
    if( !wxDir::Exists( strPath ) ) {
        ::wxMkdir( strPath );
        // lack of configuration dir tells application this is the first time it's being
        // run.
        m_bisFirstTimeRun = true;
    }
...
>   static OILPreferences* OILPreferences::GetIsFirstTimeRun()

    Author:     Earl Ducaine
    Created:    16/July/2020
    Returns:    true if this is the first time the application has been run, false otherwise.
    Purpose:    Indicates whether this is the first time the application has been run.

********************************************************************************************/

bool OILPreferences::GetIsFirstTimeRun()
{

    return m_bisFirstTimeRun;
}
