...
BOOL ImageMagickFilter::ConvertFromTempFile(CCLexFile * File)
{
	...
	const wxStringCharType* cifn;
	const wxStringCharType* cofn;
	wxStringCharType* pcommand="/usr/bin/convert";
	const wxStringCharType* IMargv[4];
...
BOOL ImageMagickFilter::ConvertToTempFile(CCLexFile * File)
{
	...
	const wxStringCharType* cofn;
	wxStringCharType* pcommand="/usr/bin/convert";
	const wxStringCharType* IMargv[10];
	const wxStringCharType* cdpi = NULL;
