...
// $Id: blobs.h 1282 2006-06-09 09:46:49Z alex $
...
>   class BlobManager : public MessageHandler
    ...
    Purpose:   Class to Manage the various types of selection blobs in Camelot. Currently
               ...
               where the fill starts and ends, its direction etc.

               Object Blobs - The blobs that appear to edit the shape of an object. ie the
               control point blobs on a path
               ...
               Boundary selection mode of the selector tool to indicate that it is one of
